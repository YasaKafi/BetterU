...
Widget buildOtpVerificationPage(
  ...
  return Stack(
    children: [
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                CommonButton(
                  text: 'Selanjutnya',
                  onPressed: () => controller.postOtpCheck(),
                  width: screenWidth,
                  height: 60,
                  borderRadius: 10,
                  icon: controller.isLoading.value == false ? Text('Verifikasi', style:  txtButton.copyWith(
      ...
      Obx(() {
        return controller.isResendingOtp.value
            ? Container(
          color: Colors.black.withOpacity(0.2), // Overlay background
          child: Center(
